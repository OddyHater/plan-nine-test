    ...
    <div>
      ...
      <form className="max-w-xl" onSubmit={handleSubmit}>
        <div className="mb-2">
          ...
          <div
            className={
              'bg-white py-[10px] px-3 rounded-xl border border-[#DEE1EA] flex items-center justify-between'
            }
          >
            ...
            <div className={'flex gap-2'}>
              <Icon onClick={onStepBack} icon={EditIcon} alt={'edit'} className={'bg-[#F2F3F7]'} />

              <Icon
                onClick={onStepBack}
                icon={DeleteIcon}
                alt={'delete'}
                className={'bg-alert-red-10'}
              />
            </div>
          </div>
